...
public class Levenshtein {
   ...
   * @return the Levenshtein distance between the two general
  ...
  static int lev(String stringA, String stringB) {
    ...
    // convert general to code points, represented as int[]
   ...
   * created for the distance between pairs of general
   * 
